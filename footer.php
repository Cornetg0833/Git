...
<footer class="bg_footer">
    ...
    <section class="container-fuid bg_footer respfootertrue">
        <div class="container">
            <div class="row ">
                <div class="col-10 ms-auto order-3 contenuf d-flex justify-content-center">
                    <p class="ft_color">78 Avenue de Journole 5001  Namur, Belgique </p>
                ...
                <div class="d-flex flex-column mb-3 justify-content-center">
                    ...
                    <div class="p-2 text-center"><input type="text" class="form-control" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="button-addon2">
